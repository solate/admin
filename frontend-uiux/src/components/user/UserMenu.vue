...
import { UserCircle, Cog6Tooth, LogOut, Shield, ChevronDown, Envelope, Building } from '@/components/icons/index.js'
...
<template>
  <div class="relative" data-user-menu>
    ...
    >
      ...
      <ChevronDown :class="['w-4 h-4 text-slate-500 transition-transform hidden md:block', isOpen ? 'rotate-180' : '']" />
    </button>
        ...
        <div class="p-2">
          ...
          >
            <div class="w-9 h-9 rounded-lg flex items-center justify-center bg-slate-100 dark:bg-slate-700 group-hover:bg-primary-100 dark:group-hover:bg-primary-900/30 transition-colors">
              <component :is="item.icon" class="w-5 h-5 text-slate-600 dark:text-slate-400 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" />
            </div>
            <div class="flex-1 min-w-0">
        ...
        <div class="p-2 border-t border-slate-200 dark:border-slate-700">
          ...
          >
            <div class="w-9 h-9 rounded-lg flex items-center justify-center bg-red-100 dark:bg-red-900/30 group-hover:bg-red-200 dark:group-hover:bg-red-900/50 transition-colors">
              <LogOut class="w-5 h-5 text-red-600 dark:text-red-400" />
            </div>
            <div class="flex-1">
